// Copyright (C) 2015-2018 Ben Deane (http://www.elbeno.com)
...
namespace cx
{
  namespace err
  {
    namespace
    {
      const char* abs_runtime_error       = "abs_runtime_error!";
      const char* fabs_runtime_error      = "fabs_runtime_error!";
      const char* sqrt_domain_error       = "sqrt_domain_error!";
      const char* cbrt_runtime_error      = "cbrt_runtime_error!";
      const char* exp_runtime_error       = "exp_runtime_error!";
      const char* sin_runtime_error       = "sin_runtime_error!";
      const char* cos_runtime_error       = "cos_runtime_error!";
      const char* tan_domain_error        = "tan_domain_error!";
      const char* atan_runtime_error      = "atan_runtime_error!";
      const char* atan2_domain_error      = "atan2_domain_error!";
      const char* asin_domain_error       = "asin_domain_error!";
      const char* acos_domain_error       = "acos_domain_error!";
      const char* floor_runtime_error     = "floor_runtime_error!";
      const char* ceil_runtime_error      = "ceil_runtime_error!";
      const char* fmod_domain_error       = "fmod_domain_error!";
      const char* remainder_domain_error  = "remainder_domain_error!";
      const char* fmax_runtime_error      = "fmax_runtime_error!";
      const char* fmin_runtime_error      = "fmin_runtime_error!";
      const char* fdim_runtime_error      = "fdim_runtime_error!";
      const char* log_domain_error        = "log_domain_error!";
      const char* tanh_domain_error       = "tanh_domain_error!";
      const char* acosh_domain_error      = "acosh_domain_error!";
      const char* atanh_domain_error      = "atanh_domain_error!";
      const char* pow_runtime_error       = "pow_runtime_error!";
      const char* erf_runtime_error       = "erf_runtime_error!";
    }
  }
